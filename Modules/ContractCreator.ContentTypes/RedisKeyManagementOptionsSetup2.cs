...
public class RedisKeyManagementOptionsSetup2 : IConfigureOptions<KeyManagementOptions>
{
    ...
    public RedisKeyManagementOptionsSetup2(
        IRedisService redis,
        IOptions<RedisOptions> options,
        ShellSettings shellSettings,
        ILogger<RedisKeyManagementOptionsSetup2> logger,
